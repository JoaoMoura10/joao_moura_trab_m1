            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        ...
                        <a href="{{ url('produto') }}" class="btn-info btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {!! Form::label(__('Nome do Produto:')) !!}
                        {!! Form::text("nome", $produto->nome ,["class"=>"form-control","required"=>"required"]) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label(__('Descrição:')) !!}
                        {!! Form::text("descricao", $produto->descricao ,["id" => "produto", "class"=>"form-control mmss","required"=>"required"]) !!}
                    </div>
